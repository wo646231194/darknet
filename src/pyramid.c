...
char *object_name[] = {"person"};

void train_pyramid(char *cfgfile, char *weightfile)
{
    char *train_images = "/home/huyang/桌面/Darknet/Caltech_data/Caltech/train.txt";
    char *backup_directory = "/home/huyang/桌面/Darknet/Caltech_data/backup/";
    srand(time(0));
...
void validate_pyramid_recall(char *cfgfile, char *weightfile)
{
    ...
    for(i = 0; i < m; ++i){
        ...
        get_maploss_boxes(l, orig.w, orig.h, thresh, probs, boxes, 1);
...
void test_pyramid(char *cfgfile, char *weightfile, char *filename, float thresh)
{
    ...
    while(1){
        ...
        get_maploss_boxes(l, 1, 1, thresh, probs, boxes, 0);
        if (nms) do_nms_sort(boxes, probs, l.outputs / 5, l.classes, nms);
        //draw_detections(im, l.outputs / 5, thresh, boxes, probs, object_name, alphabet, l.classes);
        draw_detections(im, l.outputs / 5, thresh, boxes, probs, object_name, 0, l.classes);
